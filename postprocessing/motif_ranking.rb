...
motif_centered_metrics = motif_metrics_combined.group_by{|info| info[:tf] }.flat_map{|tf, tf_infos|
  tf_infos.group_by{|info| info[:motif] }.map{|motif, motif_infos|
    ...
    motif_ranks[:affiseq_IVT_reads] = motif_ranks[:affiseq_10_IVT_ROC]
    ...
    motif_ranks[:affiseq_Lysate_reads] = motif_ranks[:affiseq_10_Lysate_ROC]
    ...
    motif_ranks[:selex_IVT] = motif_ranks[:selex_10_IVT_ROC]
    motif_ranks[:selex_Lysate] = motif_ranks[:selex_10_Lysate_ROC]
    ...
    motif_ranks[:smileseq] = motif_ranks[:smileseq_10_ROC]
    ...
    motif_values[:affiseq_IVT_reads] = motif_values[:affiseq_10_IVT_ROC]
    ...
    motif_values[:affiseq_Lysate_reads] = motif_values[:affiseq_10_Lysate_ROC]
    ...
    motif_values[:selex_IVT] = motif_values[:selex_10_IVT_ROC]
    motif_values[:selex_Lysate] = motif_values[:selex_10_Lysate_ROC]
    ...
    motif_values[:smileseq] = motif_values[:smileseq_10_ROC]
