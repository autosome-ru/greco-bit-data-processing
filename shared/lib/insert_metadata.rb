InsertMetadata = Struct.new(*[
  ...
  def self.from_string(line)
    insert_id, source_tf_gene, dbd_type, dbd_type_from_HumanTFs, 
      amino_acid_sequence, aa_length, recoded_dna_sequence, dna_length, 
      smileseq_eGFP_clone_id, biobasic_UT380_clone, smileseq_missing_name, smileseq_plasmid_backbone,
      ...
      plasmid_numbers = [parse_cell(eGFP_plasmid_number), parse_cell(t7_GST_plasmid_number), parse_cell(biobasic_UT380_clone)].compact
    self.new(
