  ...
  SampleMetadata = Struct.new(*[
    ...
    def self.from_string(line)
      ...
      self.new(
        ...
        cycle_1_filename: cycle_1_filename, cycle_2_filename: cycle_2_filename, cycle_3_filename: cycle_3_filename, cycle_4_filename: cycle_4_filename,
        cycle_1_read_2_filename: cycle_1_read_2_filename, cycle_2_read_2_filename: cycle_2_read_2_filename, cycle_3_read_2_filename: cycle_3_read_2_filename,
        folder: folder,
      )
    end
